...
<html>
  ...
  <body>
	...
	<div class="main">
	 	...
	 	<div class="maininfo">
	 		<ul class="ullist">
	 		<c:forEach items="${annoucement_pageInfo.annoucements}" var="list">
	 			<li class="infoli"><img  src="<%=basePath %>img/arrow1.png" >
	 			   <a class="b" href="${pageContext.request.contextPath}/annoucement/${list.id}">${list.title }</a>
	 	...
	 	<div class="page_div">
	 		<div class="pageinfo">
	 		<a  id="first" href="/Home-BasedCare/annoucement/list/0/15">首页</a> 
            <a id="former" href="/Home-BasedCare/annoucement/list/${annoucement_pageInfo.currentPage-1}/15">上一页</a>
	 	    <a id="next" href="/Home-BasedCare/annoucement/list/${annoucement_pageInfo.currentPage+1}/15">下一页</a>
	 		<a id="last" href="/Home-BasedCare/annoucement/list/${annoucement_pageInfo.totalPages-1}/15">尾页</a>&nbsp;&nbsp;
	 		<span>共${annoucement_pageInfo.totalCount}条</span>&nbsp;
	 	    <span>每页显示15条</span>&nbsp;
	 	    <div id="page" style="display: inline-block;">第${annoucement_pageInfo.currentPage+1}页</div>
	 		</div>
	 	</div>
	</div>
	<div class="foot">
	...
	<script type="text/javascript">
		var current = ${annoucement_pageInfo.currentPage}
		console.log(current);
		console.log(${annoucement_pageInfo.totalPages});
		if(current==0){
			$("#first").hide();
			$("#former").hide();
		}
		if(current==${annoucement_pageInfo.totalPages-1}){
			console.log("lalal");
			$("#next").hide();
			$("#last").hide();
		}
